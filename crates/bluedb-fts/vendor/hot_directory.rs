...
// Adapted for bluedb: `quickwit_storage::VersionedComponent` and
// `crate::{CachingDirectory, DebugProxyDirectory}` repointed to the local
// `super::` modules, and `crate::read_only_directory!` to `super::`.
...
use super::{CachingDirectory, DebugProxyDirectory, VersionedComponent};
