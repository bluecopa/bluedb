...
// Adapted for bluedb: `quickwit_storage::ByteRangeCache` and
// `quickwit_storage::metrics::SHORTLIVED_CACHE` repointed to the local `super::`
// modules, and the `crate::` references (macro, test imports) to `super::`.
...
impl CachingDirectory {
    ...
    pub fn new_unbounded(underlying: Arc<dyn Directory>) -> CachingDirectory {
        let byte_range_cache =
            ByteRangeCache::with_infinite_capacity(&super::metrics::SHORTLIVED_CACHE);
...
mod tests {
    ...
    use super::super::DebugProxyDirectory;
