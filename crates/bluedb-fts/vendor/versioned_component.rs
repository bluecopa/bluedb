...
// `quickwit-storage/src/versioned_component.rs`; only the test module's
// `use crate::VersionedComponent` was rewritten to `use super::...` for the
// module layout.
