...
// Adapted for bluedb: copied verbatim from `quickwit-storage/src/error.rs`
// except the single `crate::StorageErrorKind` path (in `StorageResolverError`)
// was rewritten to a local `StorageErrorKind`, since this now lives in a module
